...
SECRET_KEY = 'django-insecure-zqqx1mz!h80=j9@77xwabd2ix!z04-zp3&_$6kbs65_)h+1r1i'
...
else:  # Use SQLite locally, when postgresql database will expire on April 28, 2025
    DATABASES = {
        'default': {
